...
#define Q(a,b,c,d)((typeof(a))0x1p2000l>(typeof(a))0x1p1999l?(typeof(a))b(a):(typeof(a))0x1p901>(typeof(a))0x1p900?(typeof(a))c(a):(typeof(a))d(a))
...
#define round(a)Q(a,roundl,round,roundf)
...
#define fmod(a)Q(a,fmodl,fmod,fmodf)
...
#define remainder(a)Q(a,remainderl,remainder,remainderf)
...
#define hypot(a)Q(a,hypotl,hypot,hypotf)
...
#undef cbrt
#define cbrt(a)Q(a,cbrtl,cbrt,cbrtf)
...
#define frexp(a)Q(a,frexpl,frexp,frexpf)
...
#define log2(a)Q(a,log2l,log2,log2f)
