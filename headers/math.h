...
D cos(D a){a=fmod(a,0xc.90fdaa22168c235p-1)+0xc.90fdaa22168c235p-1;long D v=1,c=-a*a/2,e=3;while(v!=v+c)v+=c,c*=-a*a,c/=e++*e++;R v;}
D sin(D a){R cos(a-0xc.90fdaa22168c235p-3);}
