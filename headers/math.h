...
long D C(long D f){long D g=0,o=f;do(g+=o)*g>f&&(g-=o);while(g+(o/=2)!=g);R(f>0)*g;}
long D P(long D k){union{long D f;long i[2];}r={.f=k-(int)k+1};long D o=1,p=2;while(*r.i)p=C(p),(*r.i<<=1)&(1ull<<63)&&(o*=p);R o*ldexp(1,k);}
...
D cos(D a){long D v=1,c=-a*a/2,e=3;while(v!=v+c)v+=c,c*=-a*a,c/=e++*e++;R v;}
D sin(D a){R cosc(a-0xc.90fdaa22168c235p-3);}
